...
<template>
  <div class="min-h-screen bg-[#020817] overflow-y-auto">
    <div class="max-w-sm mx-auto p-6 space-y-5">
      ...
      <div class="bg-[#0F172A] border border-slate-800 rounded-3xl p-5 animate-fade-in">
        <div class="flex items-center gap-4">
          <div class="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl font-black text-white shadow-lg flex-shrink-0"
          ...
          <div>
            ...
            <div class="flex items-center gap-2 mt-1">
              <span class="text-xs font-bold px-2 py-0.5 rounded-lg bg-indigo-900/40 text-indigo-300 border border-indigo-500/30">
                Nível {{ auth.level }}
              </span>
      ...
      <div class="bg-[#0F172A] border border-slate-800 rounded-2xl p-5 animate-fade-in">
        ...
        <div class="h-3 bg-slate-800 rounded-full overflow-hidden">
          <div
            ...
            :style="{ width: `${auth.xpProgress * 100}%` }"
          />
        </div>
      ...
      <transition name="fade">
        <div v-if="showSettings" class="bg-[#0F172A] border border-slate-800 rounded-2xl overflow-hidden animate-fade-in">
